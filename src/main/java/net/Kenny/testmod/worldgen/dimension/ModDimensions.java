package net.Kenny.testmod.worldgen.dimension;
...
public class ModDimensions {
    public static final ResourceKey<LevelStem> DIM_KEY = ResourceKey.create(Registries.LEVEL_STEM,
            ResourceLocation.fromNamespaceAndPath(TestMod.MOD_ID, "dim"));
    ...
    public static void bootstrapStem(BootstrapContext<LevelStem> context) {
        ...
        NoiseBasedChunkGenerator wrappedChunkGenerator = new NoiseBasedChunkGenerator(
                new FixedBiomeSource(biomeRegistry.getOrThrow(ModBiomes.CUSTOM_BIOME)),
